        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                    ...
                    <td align="center"><? echo $row["status"] == 0 ? "Ativo" : "Inativo"; ?> </td> 
                </tr>
                <?php
            }
            ?>
            ...
            <tr>
                ...
                <input type="button" value="Gerar TXT" onClick="location.href='controle/gerarTXT.php?status=<?= $status ?>&cidade=<?= $cidade ?>&paroquia=<?=$paroquia?>';"></td>                                               
